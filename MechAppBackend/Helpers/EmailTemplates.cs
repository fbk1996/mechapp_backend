...
<body width='100%' style='margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;'>
	<center style='width: 100%;'>
        ...
        public static string SendAddDeletedClientMessageTitle = $"{appdata.companyName} - Twoje nowe konto w naszym warsztacie!";

        public static string SendAddDeletedClientMessage = @"<!DOCTYPE html>
<html lang='pl' xmlns='http://www.w3.org/1999/xhtml' xmlns:v='urn:schemas-microsoft-com:vml'
	xmlns:o='urn:schemas-microsoft-com:office:office'>
						...
						<table role='presentation' border='0' cellpadding='0' cellspacing='0' width='100%'>
							<tr>
								<td style='padding: 0 2.5em; text-align: center; padding-bottom: 3em;'>
									<div class='text'>
										<h2>Witaj #name #lastname<br /></h2><br>
                                        <h5>Dziękujemy za powrót do naszej społeczności. Jesteśmy gotowi na obsługę Twojego pojazdu. Czekamy na Ciebie w naszym warsztacie!</h5>
									</div>
								</td>
							</tr>
							<tr>
